...
- Dizajn: obvezna pravila u `.cursor/rules/ui-design.mdc` i `.cursor/rules/ui-conventions.mdc` — ista obitelj kao udruga-saas (tokeni, landing bez org navbara, hamburger, Postavke/Izgled). Ne izmišljaj paletu ni chrome.
