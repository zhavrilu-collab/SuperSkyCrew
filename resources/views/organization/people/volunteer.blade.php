...
@section('title', 'Kartica volontera — '.$person->fullName())
...
@section('content')
    <h1 class="h4 mb-1">Kartica volontera</h1>
    <p class="text-muted">Operativni status u kadru. Nije evidencija radnika (čl. 3.) ni evidencija drugih FO (čl. 10.). Grant sati nisu v1.</p>

    <dl class="row">
        <dt class="col-sm-3">Organizacija</dt>
        ...
        <dt class="col-sm-3">Akt / program</dt>
        <dd class="col-sm-9">{{ $person->instrument_title ?: '—' }}</dd>
        <dt class="col-sm-3">Mjesto / posao</dt>
    ...
    <p class="small text-muted mb-0">Volonter se ne prijavljuje na šihtericu i nije u matičnoj knjizi radnika.</p>
@endsection
